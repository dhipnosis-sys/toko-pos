...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0 fw-bold">@lang('app.edit_role'): {{ $role->display_name }}</h4>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        @if($role->is_system)
                            ...
                            <small class="text-muted">@lang('app.system_role') — @lang('app.cannot_edit_system_role')</small>
                        @else
                ...
                <div class="card border mb-3">
                    <div class="card-header bg-light py-2">
                        <div class="form-check">
                            <input class="form-check-input group-check" type="checkbox" data-group="{{ $group }}" id="group_{{ Str::slug($group) }}"
                                {{ $perms->every(fn($p) => $role->permissions->contains($p->id)) ? 'checked' : '' }}>
                    ...
                    <div class="card-body py-2">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input perm-check" type="checkbox" name="permissions[]" value="{{ $perm->id }}" id="perm_{{ $perm->id }}"
